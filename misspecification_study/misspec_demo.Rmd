...
The catch and index four panel plots all look good for UR_em4. The problematic diagnostic is the NAA 4 panel plots, show below for ages 1 and 8 as well as the stacked barplot of residuals.
...
em8lr.dir <- file.path(here(), "misspecification_study", "UR_em4", "liz_retro_plots")
plot.retro.pars(m=em_fits[[8]][[1]], yr.plot.start=2005, od=em8lr.dir, save.name="UR_em4", 
  plot.f='png' )
```
...
![fleet selectivity](UR_em4/liz_retro_plots/UR_em4._fleet.sel.full.plot.png)

![index selectivity](UR_em4/liz_retro_plots/UR_em4._ind.sel.full.plot.png)

![NAA log deviations](UR_em4/liz_retro_plots/UR_em4._naa.devs.full.plot.png)

![Survey catchability](UR_em4/liz_retro_plots/UR_em4._q.full.plot.png)
