...
layout.x <- layout(x) 
par(oma = c(0,0,0,0))
plot.prune(full.trees[["R"]],0.01, "R", tweak = 1.2, mar = c(0,0,5,0))
mtext("R OMs", side = 3, line = 0, cex = 2)
plot.prune(full.trees[["R+S"]],0.015, "R+S", tweak = 1.2, mar = c(0,0,5,0))
mtext("R+S OMs", side = 3, line = 0, cex = 2)
plot.prune(full.trees[["R+M"]],0.02, "R+M", tweak= 1.2, mar = c(0,0,5,0))
mtext("R+M OMs", side = 3, line = 0, cex = 2)
plot.prune(full.trees[["R+Sel"]],0.02, "R+Sel", tweak = 1.2, mar = c(0,0,5,0))
mtext("R+Sel OMs", side = 3, line = 0, cex = 2)
plot.prune(full.trees[["R+q"]],0.03, "R+q", tweak = 1.2, mar = c(0,0,5,0))
