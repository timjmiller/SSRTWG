...
sapply(1:24, function(y) sapply(1:100, function(x) aggregate_hpcc_results(sim = x, oms = y, ems = 1:20, res_dir = file.path(here::here(),"Project_0", "results", "naa_om"))))
...
sapply(1:16, function(y) sapply(1:100, function(x) aggregate_hpcc_results(sim = x, oms = y, ems = ems, res_dir = file.path(here::here(),"Project_0", "results", "Sel_om"))))
...
sapply(1:16, function(y) sapply(1:100, function(x) aggregate_hpcc_results(sim = x, oms = y, ems = ems, res_dir = file.path(here::here(),"Project_0", "results", "q_om"))))
