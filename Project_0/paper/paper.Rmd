...
convergence types: 
1) whether the optimization completed
2) nlminb convergence flag = 0
3) max abs gradient < 1e-6
4) No NAs for SE of fixed effects returned from TMB::sdreport
5) No SE NAs AND no SE > 100
