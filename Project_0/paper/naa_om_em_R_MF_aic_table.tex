%latex.default(out, file = here("Project_0", "paper", "naa_om_em_R_MF_aic_table.tex"),     table.env = FALSE, col.just = rep("r", dim(out)[2]), rowname = NULL)%
\begin{center}
...
$0.5$&$0.50$&H-MSY&L&$ 0$&$ 99$&$1$&$0$&$0$\tabularnewline
