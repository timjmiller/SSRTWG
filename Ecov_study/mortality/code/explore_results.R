...
#x <- readRDS(file.path(here::here(),"Ecov_study","mortality", "results", paste0("om", 1), paste0("sim", 3, "_em", 4, ".RDS")))
#x <- readRDS(file.path(here::here(),"Ecov_study","mortality", "results", "aggregated_results", paste0("om_", 1, "_em_", 4, ".RDS")))
...
#conv_res = lapply(1:1, function(y){
  ...
  #lapply(4:4, function(x) {
    res <- readRDS(file.path(here::here(),"Ecov_study","mortality", "results", "aggregated_results", paste0("om_", y, "_em_", x, ".RDS")))
    print(paste(y, x))
...
x <- readRDS(file.path(here::here(),"Ecov_study","mortality", "results", "aggregated_results", paste0("om_", 53, "_em_", 4, ".RDS")))
x <- readRDS(file.path(here::here(),"Ecov_study","mortality", "results", "aggregated_results", paste0("om_", 53, "_em_", 10, ".RDS")))

#res <- readRDS(file.path(here::here(),"Ecov_study","mortality", "results", "aggregated_results", paste0("om_", 1, "_em_", 1, ".RDS")))
...
saveRDS(ecov_beta_bias_res, file = file.path(here::here(),"Ecov_study","mortality", "results", "ecov_beta_bias_results.RDS"))
...
ssb_res = lapply(1:NROW(df.oms), function(i){
  ...
  for(j in 1:NROW(df.ems)){
    print(paste(i, j))
    res <- readRDS(file.path(here::here(),"Ecov_study","mortality", "results", "aggregated_results", paste0("om_", i, "_em_", j, ".RDS")))
...
saveRDS(ssb_res, file = file.path(here::here(),"Ecov_study","mortality", "results", "ssb_results.RDS"))
...
saveRDS(depletion_error, file = file.path(here::here(),"Ecov_study","mortality", "results", "depletion_error_results.RDS"))
...
saveRDS(ssb_term_bias_res, file = file.path(here::here(),"Ecov_study","mortality", "results", "ssb_term_bias_res.RDS"))
...
res <- readRDS(file.path(here::here(),"Ecov_study","mortality", "results", "aggregated_results", paste0("om_", 184, "_em_", 6, ".RDS")))
ind <- which(sapply(res, length) != 0)
