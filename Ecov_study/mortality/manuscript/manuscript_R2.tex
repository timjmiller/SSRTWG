...
\subsection*{Percent deviance reduction}\label{percent-deviance-reduction}
\addcontentsline{toc}{subsection}{Percent deviance reduction}

\subsubsection*{EM Convergence}\label{em-convergence-2}
\addcontentsline{toc}{subsubsection}{EM Convergence}
...
\subsection*{Covariate effect bias}\label{covariate-effect-bias-1}
...
\subsection*{Terminal year spawning stock biomass bias}\label{terminal-year-spawning-stock-biomass-bias-1}
...
\subsection*{Terminal year spawning stock biomass accuracy}\label{terminal-year-spawning-stock-biomass-accuracy-1}
