...
\]
All biological inputs to calculations of spawning biomass per recruit (i.e., weight, maturity, and natural mortality at age) are constant in the R and R+S OMs without covariate effects on natural mortality. Therefore, steepness and unfished recruitment are also constant over the time period for those OMs [@millerbrooks21] and with our assumed biological inputs and selectivity the fishing mortality resulting in 40\% reduction in spawning biomass per recruit is $F_{40\%} = 0.348$. With an assumed unfished recruitment of $R_0 = e^{10}$, setting $\Fmsy = \Fspr[40]$ results in a steepness of 0.69 and $a=0.60$ and $b = 2.4 \times 10^{-5}$ (Figure \ref{om_inputs_fig}, bottom right). 
