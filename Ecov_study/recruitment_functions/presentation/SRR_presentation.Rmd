...
- Blue indicates EM=OM (diagonal of first 4 columns w/in facet blocks), incorrect EMs in red
 ...
 ```{r,  echo=FALSE, message=FALSE, warnings=FALSE,  out.height='65%', fig.align='center'}
...
- Limiting and Masking had worst performance (BH_3 and BH_4)
...
- A 5-year average of maturity, weight at age, and selectivity specified (time-invariant anyway)
...
- In WP-1, we recommended exploring additional levels of $\sigma_{R}$=0.5; however, we note that WP1-Appendix looked at $\sigma_{R}$=0.5 and found no difference 
