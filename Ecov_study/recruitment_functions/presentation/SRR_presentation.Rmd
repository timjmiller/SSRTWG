...
# Sims
## Simulated Data Examples - Type 1
...
<!-- ```{r, echo=FALSE, message=FALSE, warnings=FALSE, out.width='40%', fig.align='center'} -->
<!--  knitr::include_graphics(file.path(here::here(), 'Ecov_study','recruitment_functions', 'presentation', 'om_57.59.61.63.121.123.125.127.185.187.189.191.249.251.253.255._Recr.plot.png') ) -->
<!-- ``` -->
...
<!-- ```{r, echo=FALSE, message=FALSE, warnings=FALSE, out.width='40%', fig.align='center'} -->
<!--  knitr::include_graphics(file.path(here::here(), 'Ecov_study','recruitment_functions', 'presentation', 'om_57.59.61.63.121.123.125.127.185.187.189.191.249.251.253.255._SSB.png') ) -->
<!-- ``` -->
...
- Blue indicates EM=OM (diagonal of first 4 columns w/in facet blocks), incorrect EMs in red
...
- Smaller $\Delta$AIC when $\sigma_{R}$ is larger
...
## Projection Summary
- Minimal difference in median bias
...
- Ecov models with trends or AR(2) dynamics
