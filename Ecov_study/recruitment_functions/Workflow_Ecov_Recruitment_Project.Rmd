...
1. Create dataframes that have AIC info and convergence info: run **AIC_dataframe.R** to produce
   ...
   + **<span style="color: red;">STATUS: done for beta standardized; </span>**
...
4. Look at bias in SSB, Recr, Fbar **bias_assessment.R**
   ...
   + **<span style="color: blue;">STATUS: done for beta unstandardized; </span>**
   + **<span style="color: red;">STATUS: pending for beta standardized; </span>**
   
4. Fit GLMs and GLMMs to assessment bias results
   + **<span style="color: blue;">STATUS: pending for beta unstandardized; </span>**
   + **<span style="color: red;">STATUS: pending for beta standardized; </span>**
...
5. Look at bias in parameter estimates **bias_parameters.R**
   ...
   + Runtime ...pending
   + **<span style="color: blue;">STATUS: pending beta unstandardized; </span>**

5a. Fit GLMs and GLMMs to parameter bias results
