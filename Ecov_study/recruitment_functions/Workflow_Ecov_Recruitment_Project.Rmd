...
5. Cleaning up script **compare_projections.R**
   + this calculates mohn's rho for user-specified number of peels, evaluates relative error from peel 10 to peel 0, ...
   + Runtime ...
