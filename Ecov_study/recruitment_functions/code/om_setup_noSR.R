...
saveRDS(df.oms, file.path(here(), "Ecov_study", "recruitment_functions", "inputs", "df.oms_noSR.RDS"))
...
saveRDS(om_inputs, file.path(here(),"Ecov_study", "recruitment_functions", "inputs", "om_inputs_noSR.RDS"))
