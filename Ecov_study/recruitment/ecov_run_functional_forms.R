...
om_inputs <- readRDS(file.path(here::here(),"Ecov_study", "recruitment", "inputs_05_10_2023", "om_inputs.RDS"))
em_inputs <- readRDS(file.path(here::here(),"Ecov_study", "recruitment", "inputs_05_10_2023", "em_inputs.RDS"))
df.ems <- readRDS(file.path(here::here(),"Ecov_study", "recruitment", "inputs_05_10_2023", "df.ems.RDS"))
df.oms <- readRDS(file.path(here::here(),"Ecov_study", "recruitment", "inputs_05_10_2023", "df.oms.RDS"))
...
for(omj in 1:nrow(df.oms)){
  
  write.dir <- file.path(here::here(),"Ecov_study", "recruitment", "results_05_10_2023", paste0("om", omj))
...
#Ecov_study/mortality/results/om_x/simy_em_z.RDS
      rds.fn = file.path(here::here(), "Ecov_study", "recruitment", "results_05_10_2023", paste0("om", omj), paste0("sim", simi, "_em", emk, ".RDS"))
