...
write.dir <- file.path(here(),"Ecov_study", "recruitment", "inputs_05_10_2023")
...
# look at model table
df.oms
saveRDS(df.oms, file.path(here(),"Ecov_study", "recruitment", "inputs_05_10_2023", "df.oms.RDS"))
...
saveRDS(om_inputs, file.path(here(), "Ecov_study", "recruitment", "inputs_05_10_2023", "om_inputs.RDS"))
